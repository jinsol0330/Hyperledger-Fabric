...
#   infoln "Creating the User1"

#   export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/peerOrganizations/org1.example.com/

#   infoln "Registering User1"
#   set -x
#   fabric-ca-client register --caname ca-org1 --id.name jinsol --id.secret jinsolpw --id.type client --tls.certfiles "${PWD}/organizations/fabric-ca/org1/tls-cert.pem"
#   { set +x; } 2>/dev/null

#   infoln "Generating the User1 msp"
#   set -x
#   fabric-ca-client enroll -u https://jinsol:jinsolpw@localhost:7054 --caname ca-org1 -M "${PWD}/organizations/js/jinsol@org1.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org1/tls-cert.pem"
#   { set +x; } 2>/dev/null

#   cp "${PWD}/organizations/peerOrganizations/org1.example.com/msp/config.yaml" "${PWD}/organizations/js/jinsol@org1.example.com/msp/config.yaml"

# }

# function createUser2() {
#   infoln "Creating the User2"

#   export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/peerOrganizations/org2.example.com/

#   infoln "Registering User2"
#   set -x
#   fabric-ca-client register --caname ca-org2 --id.name yulhee --id.secret yulheepw --id.type client --tls.certfiles "${PWD}/organizations/fabric-ca/org2/tls-cert.pem"
#   { set +x; } 2>/dev/null

#   infoln "Generating the User2 msp"
#   set -x
#   fabric-ca-client enroll -u https://yulhee:yulheepw@localhost:8054 --caname ca-org2 -M "${PWD}/organizations/yh/yulhee@org2.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org2/tls-cert.pem"
#   { set +x; } 2>/dev/null

#   cp "${PWD}/organizations/peerOrganizations/org2.example.com/msp/config.yaml" "${PWD}/organizations/yh/yulhee@org2.example.com/msp/config.yaml" 
# }
...
function createUser1() {
  ...
  infoln "Generating the User1 msp"
  set -x
  fabric-ca-client enroll -u https://jinsol:jinsolpw@localhost:7054 --caname ca-org1 -M "${PWD}/organizations/peerOrganizations/org1.example.com/users/jinsol@org1.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org1/tls-cert.pem"
  { set +x; } 2>/dev/null

  cp "${PWD}/organizations/peerOrganizations/org1.example.com/msp/config.yaml" "${PWD}/organizations/peerOrganizations/org1.example.com/users/jinsol@org1.example.com/msp/config.yaml"
...
function createUser2() {
  ...
  infoln "Generating the User2 msp"
  set -x
  fabric-ca-client enroll -u https://yulhee:yulheepw@localhost:8054 --caname ca-org2 -M "${PWD}/organizations/peerOrganizations/org2.example.com/users/yulhee@org2.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org2/tls-cert.pem"
  { set +x; } 2>/dev/null

  cp "${PWD}/organizations/peerOrganizations/org2.example.com/msp/config.yaml" "${PWD}/organizations/peerOrganizations/org2.example.com/users/yulhee@org2.example.com/msp/config.yaml" 
}