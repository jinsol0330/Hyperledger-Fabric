...
async function main() {
    ...
    try {
        ...
        // Transfer token
        console.log('4. Submit Transfer transaction.');
        const recipient = process.argv[2];
        const amount = process.argv[3];

        const transferResponse = await contract.submitTransaction('Transfer', recipient, amount);

        // process response
        console.log(`Transaction has been evaluated, result : Transfer ${amount} to ${recipient}`);
...
main().then(() => {
    ...
    console.log('7. Transfer program complete.');
