...
async function main() {
    ...
    try {
        ...
        // Burn token
        console.log('4. Submit Burn transaction.');

        const burnResponse = await contract.submitTransaction('Burn', amount);

        // process response
        console.log(`Transaction has been evaluated, result : Burn ${amount}`);
...
main().then(() => {
    ...
    console.log('7. Burn program complete.');

}).catch((e) => {

    console.log('Burn program exception.');
    console.log(e);
    console.log(e.stack);
    process.exit(-1);
