...
async function main() {
    ...
    try {
        ...
        console.log('4. Submit ClientAccountBalance transaction.');

        const balanceofResponse = await contract.submitTransaction('ClientAccountBalance');

        console.log(`Transaction has been evaluated, result : ${balanceofResponse}`);
...
main().then(() => {
    ...
    console.log('7. ClientAccountBalance program complete.');

}).catch((e) => {

    console.log('ClientAccountBalance program exception.');
    console.log(e);
    console.log(e.stack);
    process.exit(-1);
