...
async function main() {
    ...
    try {
        ...
        console.log('4. Submit ClientAccountID transaction.');

        const IDResponse = await contract.submitTransaction('ClientAccountID');

        console.log(`Transaction has been evaluated, result : ${IDResponse}`);
...
main().then(() => {
    ...
    console.log('7. ClientAccountID program complete.');

}).catch((e) => {

    console.log('ClientAccountID program exception.');
    console.log(e);
    console.log(e.stack);
    process.exit(-1);
